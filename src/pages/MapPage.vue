...
function addMarkersToMap(){
    ...
    location.value.forEach((el) => {
      console.log(el)
      L.marker([el.long, el.lat]).addTo(map.value).bindPopup('<img src="'+el.icon+'" class="w-[50px] h-[50px] object-cover rounded-[50%]"> <p class="font-medium min-w-[130px]"> ' + el.name + '</p>  <a href="/home?id='+el.brand+'" class="inline-block !text-sm">Ko`rish</a>')
    });
