<template>
  <div>
    ...
    <div class="container">
      ...
      <div class="translate-y-[-10px]"></div>
      <div class="translate-y-[-10px]">
        ...
        <div class="grid grid-cols-2 gap-5 mt-5">
          <router-link
            to="/brand/1"
            class="dark:bg-[#1A1A1A] rounded-[25px] p-5 flex justify-center items-center"
          >
      ...
      <div class="mt-[30px]">
        ...
        <div class="grid grid-cols-1 gap-[30px] mt-5">
          <router-link
            to="/brand/1"
            class="dark:bg-[#1A1A1A] rounded-[25px] p-5 flex justify-center items-center max-h-[250px]"
          >
