<template>
  <div>
    ...
    <div class="container">
      ...
      <div class="translate-y-[-10px] mt-8">
        <p
        ...
        <div class="grid grid-cols-2 gap-5 mt-5">
          <div
            to="/brand/1"
            class="dark:bg-[#1A1A1A] rounded-[25px] flex justify-center items-center"
          >
            <img
              src="@/assets/fake-images/Rectangle 16.png"
              alt="sofa images"
            />
          </div>
          <div
          ...
          >
            <img
              src="@/assets/fake-images/Rectangle 17.png"
              alt="sofa images"
            />
          </div>
        </div>
      ...
      <div class="mt-[30px]">
        ...
        <div class="grid grid-cols-1 gap-[30px] mt-5">
          <div
            to="/brand/1"
            class="dark:bg-[#1A1A1A] rounded-[25px] flex justify-center items-center max-h-[250px]"
          >
            <img src="@/assets/fake-images/1.png" alt="sofa images" />
          </div>
          <div
            to="/brand/1"
            class="dark:bg-[#1A1A1A] rounded-[25px] flex justify-center items-center max-h-[250px]"
          >
            <img src="@/assets/fake-images/1 (2).png" alt="sofa images" />
          </div>
          <div
            to="/brand/1"
            class="dark:bg-[#1A1A1A] rounded-[25px] flex justify-center items-center max-h-[250px]"
          >
            <img src="@/assets/fake-images/1 (3).png" alt="sofa images" />
          </div>
        </div>
      </div>
      <div class="mt-[30px]">
